      ...
      messages: [
        {
          ...
          content: [
            {
              type: "text",
              text: `请按照如下角度分析图片内容，并返回丝滑流畅文段：1.主体对象识别 2.场景描述 3.色彩分析 4.文字提取(如有) 5.风格判断（如需）。要求：用中文输出，字数严格限定在50-500字内。确保有新意、保证用户体验，同时对人物/商品/风景等不同类别自适应处理。额外需求：${this.data.customPrompt || '无'}`
            },
            {
              type: "image_url",
              image_url: {
